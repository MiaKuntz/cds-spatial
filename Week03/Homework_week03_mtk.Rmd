...
```{r crs assign}
# Get the CRS from the zion object, where I know the CRS is GRS80 and the ESPG is therefor 42310
crs_ <- 
st_crs(zion) <- crs_
zion_crs <-crs(zion, asText = TRUE)

# Project srtm to match the CRS of aarhus
srtm_ <- projectRaster(srtm, crs = zion_crs, method = "ngb")
