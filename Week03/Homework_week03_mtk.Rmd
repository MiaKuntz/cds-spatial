...
st_crs(zion, asText = TRUE) # The CRS is UTM Zone 12, Northern Hemisphere with the coordinate system GRS80

# Assign the CRS to the zion object
crs_zion <- 42310
zion <- crs_zion

# Create new srtm object to match the zion crs
srtm2 <- srtm

# Project srtm2 to match the CRS of zion
srtm2 <- projectRaster(srtm2, crs = zion, method = "ngb")
all.equal(st_crs(zion),st_crs(srtm2))
...
# Exercise 4 (Optional) - Make a map of Denmark
