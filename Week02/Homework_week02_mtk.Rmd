---
title: "W02 - Working with sf objects"
...
The following homework was created based on the .Rmd file provided by Adela for this course. The set up and structure, along with several codes, are therefor not of my own creation, and I take no credit for these.
...
7. Change the borders' color of the New Zealand's regions to black and decrease the line width.
...
projection(zion) # Using the `projection` function shows me the CRS for this object
...
# The coordinate system
projection(srtm) # Using the `projection` function shows me the CRS for this object
# The used coordinate system is the WGS84

# Number of dimensions
dim(srtm) # Either from running the object name or by using the `dim` function we can see, that the object contains four dimensions
